...
class PaginaDetallesSsdNoSesion extends StatefulWidget {
  String idRegistro;

  PaginaDetallesSsdNoSesion(this.idRegistro);

  @override
  State<StatefulWidget> createState() => new _PaginaDetallesSsdNoSesion();
}

class _PaginaDetallesSsdNoSesion extends State<PaginaDetallesSsdNoSesion> {
  late Ssd _ssd;
