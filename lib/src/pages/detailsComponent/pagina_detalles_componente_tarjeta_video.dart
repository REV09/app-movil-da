...
class PaginaDetallesTarjetaVideoNoSesion extends StatefulWidget {
  String idRegistro;

  PaginaDetallesTarjetaVideoNoSesion(this.idRegistro);

  @override
  State<StatefulWidget> createState() =>
      new _PaginaDetallesTarjetaVideoNoSesion();
}

class _PaginaDetallesTarjetaVideoNoSesion
    extends State<PaginaDetallesTarjetaVideoNoSesion> {
