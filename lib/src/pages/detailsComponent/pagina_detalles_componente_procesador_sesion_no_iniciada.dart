...
class PaginaDetallesProcesadorNoSesion extends StatefulWidget {
  String idRegistro;

  PaginaDetallesProcesadorNoSesion(this.idRegistro);

  @override
  State<StatefulWidget> createState() =>
      new _PaginaDetallesProcesadorNoSesion();
}

class _PaginaDetallesProcesadorNoSesion
    extends State<PaginaDetallesProcesadorNoSesion> {
