...
class PaginaDetallesHddSesionIniciada extends StatefulWidget {
  String idRegistro;

  PaginaDetallesHddSesionIniciada(this.idRegistro);

  @override
  State<StatefulWidget> createState() => new _PaginaDetallesHddSesionIniciada();
}

class _PaginaDetallesHddSesionIniciada
    extends State<PaginaDetallesHddSesionIniciada> {
  late Hdd _discoDuro;
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text('Modificar disco duro'),
                        ),
                      ),
                    ],
                  ),
